...
const char* IP_NUBE = "http://TU_IP_DE_LA_NUBE_AQUI"; // REEMPLAZAR CON TU IP
...
<body>
    ...
    <div id="presentacion" class="section">
        ...
        <div class="row">
            <button class="btn" onclick="showSection('dashboard'); hablar('Accediendo al panel.')">SÍ</button>
            <button class="btn btn-danger" onclick="volver()">NO</button>
        </div>
    </div>
    ...
    <script>
        ...
        function showSection(id) { 
            ...
            if(id === 'dashboard') conectarNube();
        }

        async function conectarNube() { try { await fetch(IP_NUBE + '/status'); } catch(e) {} }
